...
class Settings(BaseSettings):
    service_role: str = "deployment-service"
    service_name: str = "deployment_service"
    service_title: str = "Deployment service"
    service_description: str = "Owns deployment lifecycle and LLMDeployment CR write requests."
